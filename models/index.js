...
db.Category = require('./category')(sequelize, Sequelize);
db.LightNovelSeriesCategory = require('./light_novel_series_category')(sequelize, Sequelize);
...
db.Category.belongsToMany(db.LightNovelSeries, { through: db.LightNovelSeriesCategory, foreignKey: 'category_id' });
db.LightNovelSeries.belongsToMany(db.Category, { through: db.LightNovelSeriesCategory, foreignKey: 'light_novel_series_id'});
